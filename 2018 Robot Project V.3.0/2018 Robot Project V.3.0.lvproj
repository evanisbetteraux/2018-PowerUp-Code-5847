...
AddOutputFilter chunkFilter
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="Collect Auto V.3.0.vi" Type="VI" URL="../Collect Auto V.3.0.vi"/>
			<Item Name="Dart Auto V.3.0.vi" Type="VI" URL="../Dart Auto V.3.0.vi"/>
			<Item Name="Elapsed Times V.3.0.vi" Type="VI" URL="../Elapsed Times V.3.0.vi"/>
			<Item Name="open joystick V.3.0.vi" Type="VI" URL="../open joystick V.3.0.vi"/>
			<Item Name="Open Pneumatics V.3.0.vi" Type="VI" URL="../Open Pneumatics V.3.0.vi"/>
			<Item Name="Open Sensors V.3.0.vi" Type="VI" URL="../Open Sensors V.3.0.vi"/>
			<Item Name="Auto kicker.vi" Type="VI" URL="../Auto kicker.vi"/>
			<Item Name="Scale Auto V.3.0.vi" Type="VI" URL="../Scale Auto V.3.0.vi"/>
			<Item Name="Auto Arms Down V.3.0.vi" Type="VI" URL="../Auto Arms Down V.3.0.vi"/>
			<Item Name="Shoot Auto V.3.0.vi" Type="VI" URL="../Shoot Auto V.3.0.vi"/>
			<Item Name="Drive Backward V.3.0.vi" Type="VI" URL="../Drive Backward V.3.0.vi"/>
			<Item Name="Reset Encoder V.3.0.vi" Type="VI" URL="../Reset Encoder V.3.0.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			<Item Name="Autonomous Independent V.3.0.vi" Type="VI" URL="../Autonomous Independent V.3.0.vi"/>
			<Item Name="Begin V.3.0.vi" Type="VI" URL="../Begin V.3.0.vi"/>
			<Item Name="Disabled V.3.0.vi" Type="VI" URL="../Disabled V.3.0.vi"/>
			<Item Name="Finish V.3.0.vi" Type="VI" URL="../Finish V.3.0.vi"/>
			<Item Name="Periodic Tasks V.3.0.vi" Type="VI" URL="../Periodic Tasks V.3.0.vi"/>
			<Item Name="Robot Global Data V.3.0.vi" Type="VI" URL="../Robot Global Data V.3.0.vi"/>
			<Item Name="Teleop V.3.0.vi" Type="VI" URL="../Teleop V.3.0.vi"/>
			<Item Name="Test V.3.0.vi" Type="VI" URL="../Test V.3.0.vi"/>
			<Item Name="Vision Processing V.3.0.vi" Type="VI" URL="../Vision Processing V.3.0.vi"/>
		</Item>
		<Item Name="Robot Main V.3.0.vi" Type="VI" URL="../Robot Main V.3.0.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Robot Global Data V.2.0.vi" Type="VI" URL="../Robot Global Data V.2.0.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../../2018 Robot Project V.1.0/Robot Global Data.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="Right Auto V.3.0.vi" Type="VI" URL="../Right Auto V.3.0.vi"/>
			<Item Name="Left Auto V.3.0.vi" Type="VI" URL="../Left Auto V.3.0.vi"/>
			<Item Name="Forward Auto V.3.0.vi" Type="VI" URL="../Forward Auto V.3.0.vi"/>
			<Item Name="Read Sensors V.3.0.vi" Type="VI" URL="../Read Sensors V.3.0.vi"/>
			...
			<Item Name="Open Motors V.3.0.vi" Type="VI" URL="../Open Motors V.3.0.vi"/>
			<Item Name="Shoot Cube Switch V.3.0.vi" Type="VI" URL="../Shoot Cube Switch V.3.0.vi"/>
			<Item Name="Kicker Switch V.3.0.vi" Type="VI" URL="../Kicker Switch V.3.0.vi"/>
			<Item Name="Read Aux Joystick V.3.0.vi" Type="VI" URL="../Read Aux Joystick V.3.0.vi"/>
			<Item Name="Kicker Drive Switch V.3.0.vi" Type="VI" URL="../Kicker Drive Switch V.3.0.vi"/>
			<Item Name="Read Drive Joystick V.3.0.vi" Type="VI" URL="../Read Drive Joystick V.3.0.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[1].itemID" Type="Ref">/Target/Robot Main V.3.0.vi</Property>
